...
st.caption("Samanburður frá upphafi Bitcoin. Íbúðavísitala er mánaðarleg; Bitcoin er rauntíma.\n"
           "⚙️ CoinGecko-köll eru nú takmörkuð með 1 klst skyndiminni til að forðast tímabundnar villur.")
...
# Caching / skyndiminni
# ----------------------
# BTC gögn (saga) uppfærast í síðasta lagi 1x á klst
@st.cache_data(ttl=3600)
def load_btc():
    return fetch_btc_history_isk()

# BTC live verð (ISK) – klst skyndiminni. Ef villa kastast, fellur það til baka í "ekki tiltækt" án þess að skemma fyrri gögn.
@st.cache_data(ttl=3600)
def load_btc_live_isk_cached():
    return fetch_btc_live_isk()

# Íbúðavísitala – ekki þörf á tíðri uppfærslu (mánaðarleg), 24 klst er nóg
